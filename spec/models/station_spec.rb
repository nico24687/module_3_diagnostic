...
describe Station do 
  it "contains the required information" do 
    station = Station.new(fuel_type_code: "random fuel", access_days_time:"never enter", station_name: "random name", station_address: "random address", distance: "random distance")
    ...
    expect(station.station_address).to eq("random address")
